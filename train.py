...
class Train(object):
    ...
    def run(self, n_iters, save_every, model_path=None):
...
if __name__ == '__main__':
    ...
    train_processor.run(config.max_iterations, model_path=args.model_path, save_every=config.save_model_every)
